...
def get_dealerships(request):
    ...
    if request.method == "GET":
        ...
        url = "https://bfknnv5vc7-3000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
...
def get_dealer_details(request, id):
     if request.method == "GET":
         context = {}
         dealer_url = "https://bfknnv5vc7-3000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
         dealer = get_dealer_by_id(dealer_url, id = id)
         context['dealer'] = dealer

         review_url = f"https://bfknnv5vc7-5000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/get_reviews?id={id}"
...
def add_review(request, id):
    ...
    if request.method == 'GET':
        ...
        if request.user.is_authenticated:
            ...
            review_post_url = "https://bfknnv5vc7-5000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/post_review"
            review = {
                "id":id,
                ...
                "car_year": car.year,  # Extract car year from POST
            }
